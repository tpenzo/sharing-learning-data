...
const PostSlice = createSlice({
   ...
   reducers: {
      ...
      createNewPost: (state, actions) => {
         actions.payload.data.status === 'posted' &&
            state.postList.unshift(actions.payload.data);
      },
      // postPostCourseList
      createNewPostCourseList: (state, actions) => {
         state.postCourseList.unshift(actions.payload.data);
      },
      ...
      // Edit postCourseList
      saveEditPostCourseList: (state, actions) => {
