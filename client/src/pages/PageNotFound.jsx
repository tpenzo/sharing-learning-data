            ...
            <div className="container h-screen bg-inherit">
              ...
              <div className="flex flex-col justify-start items-start mt-16">
                <p className='text-5xl py-7 text-cyan-400 mb-4 font-extrabold'>Không khả dụng!</p>
                  ...
                  <button onClick={navigateHomePage} type="button" class="text-white font-semibold text-lg mt-7 bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 rounded-lg px-10 py-2.5 text-center mr-2 mb-2">Trang chủ</button>
                </div>
